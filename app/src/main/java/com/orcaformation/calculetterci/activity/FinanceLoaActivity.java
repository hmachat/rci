...
public class FinanceLoaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listLoyerView = (ListView) findViewById(R.id.listLoyerView);
        ...
        listBaremeView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                listLoyerView.setAdapter(loyerAdapter);
                listLoyerView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String  loyerValue    = (String) listLoyerView.getItemAtPosition(position);
